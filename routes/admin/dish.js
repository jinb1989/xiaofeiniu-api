...
*返回数据：
*  {code:200,msg:"upload succ",fileName:"1548742053072-2584.png"}
*/
//引入multer中间件
...
/*
*POST /admin/dish
*请求参数：{title:'xxx',imhUrl:'xxx.jpg',price:xxx,detail:'xxx',categoryId:xxx}
*添加一个新的菜品
*输出信息：
*{code:200,msg:' dish added  success',dishId:40}
*/
router.post('/',(req,res)=>{
...
/**
 * PUT /admin/dish
 * 请求参数：{did:xxx,title:'xxx',imgUrl:'xxx.jpg',price:xxx,detail:'xxx',categoryId:xxx}
 * 根据指定的菜品编号修改该菜品
 * 输出数据：
